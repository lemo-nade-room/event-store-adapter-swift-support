...
struct EventSupportTests {
  ...
  @Test
  func アクセス修飾子がない場合はinternalで作成する() async throws {
    assertMacro {
      """
      @EventSupport
  ...
  @Test
  func enum以外に使用するとエラーメッセージを出す() async throws {
    assertMacro {
      """
      @EventSupport
  ...
  @Test
  func プロトコル継承なしでも動作する() async throws {
    assertMacro {
      """
      @EventSupport
  ...
  @Test
  func 非修飾名のEventプロトコルでも動作する() async throws {
    assertMacro {
      """
      @EventSupport
